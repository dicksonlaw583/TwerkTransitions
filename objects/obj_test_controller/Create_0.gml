...
types = [
	...
	["Slide in vertical 2-way (bounce)", tt_slide_in_vertical, { fadeType: undefined, slideType: te_bounce_out }],
	["Slide in horizontal 2-way (swing)", tt_slide_in_horizontal, { slideType: te_swing }],
	["Slide in 4-way (bounce)", tt_slide_in_4way, { slideType: te_bounce_out }],
	["Slide out vertical 2-way (bounce)", tt_slide_out_vertical, { fadeType: undefined, slideType: te_bounce_out }],
	["Slide out horizontal 2-way (swing)", tt_slide_out_horizontal, { slideType: te_swing }],
	...
	["Maximize from centre (elastic)", tt_maximize, { fadeType: undefined, scaleType: te_elastic_out }],
	["Horizontal flip (swing)", tt_flip_horizontal, {}],
	["Vertical flip (elastic)", tt_flip_vertical, { spinType: te_elastic_out }],
	...
	["Wipe vertical 2-way (quick)", tt_wipe_in_vertical, { wipeType: te_quintic_out }],
	["Wipe horizontal 2-way (quick, with fade)", tt_wipe_in_horizontal, { fadeType: te_linear, wipeType: te_quintic_out }],
	["Wipe 4-way (quick)", tt_wipe_in_4way, { wipeType: te_quintic_out }],
